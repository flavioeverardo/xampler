...
%Although their application and computational treatment are very active research topics (cf.~\cite{gosase07a,gohosase07b,chmeva13a,chmeva13b})
%  plain unit propagation \cite{laitinen2012conflict},
%to complete parity reasoning using Gaussian elimination \cite{soos2009extending} \cite{soos2010enhanced} \cite{laitinen2012extending} \cite{laitinen2013simulating}.).
in the neighboring area of Satisfiability Testing (SAT)%~\cite{SATHandbook})
~\cite{meel18a},
