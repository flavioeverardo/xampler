...
\label{sec:hashing}
\textbf{Basic Que}: How to Partition the $Sol(\phi)$ (solution set) into roughly equal small cells without knowing the distribution of the solution? \\
Ans: Universal hashing.

In addition we need different input to be hashed independently.
\input{approxASP}
