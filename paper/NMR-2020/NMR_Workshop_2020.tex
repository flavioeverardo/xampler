...
%
We have to perform a good hashing without the knowledge of the distribution of answer sets. i.e., partition the $Sol(\Pi)$ into cells with a roughly equal number of answer sets.
%
...
%
The higher the $k$, the harder it will be to solve the formula with these constraints. 
%
