...
Given an input ASP program \fff, the ASP counting problem (\asp) computes the total number of solutions \sol of the program \fff.
%
...
%
The algorithm takes the program \fff with a tolerance $\epsilon > 0$ and a confidence $\delta \in (0, 1]$ as an input.
%
...
Apriori we do not know the distribution of the solution set; \sol.
%
