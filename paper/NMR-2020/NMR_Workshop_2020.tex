...
The approximate model counting algorithm \appasp use 3-wise independent hashing functions from the Hxor(n, m, 3) family (for an appropriate m) to partition the set of models of an input formula into ``small" cells.
%
