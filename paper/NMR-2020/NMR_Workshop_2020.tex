...
%
To this end, we present an extension of \xorro{} towards approximate answer set counting following the work from~\cite{DBLP:conf/cp/ChakrabortyMV13}
...
that preserve the number of solutions~\cite{Janhunen06} from and to propositional satisfiability (SAT).
