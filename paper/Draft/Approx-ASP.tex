...
\begin{enumerate}
	...
	\item Example to show that direct translation of ASP problem to SAT will blow up (is exponential). In principle we can't just translate an ASP problem $\fff$ to SAT and run APPROXMC. @Ankit
