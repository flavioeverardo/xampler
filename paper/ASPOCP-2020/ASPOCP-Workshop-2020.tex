...
%
\title{Extending \xorro{} with Approximate Model Counting}
%
\titlerunning{Extending XORO with Approximate Model Counting}  % abbreviated title (for running head)
...
\begin{abstract}
Answer Set Programming (ASP) is a declarative framework that is well-suited for problems in KR, AI, and other areas as well as plenty of practical applications, in both the academy and in the industry.
